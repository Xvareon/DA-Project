...
locationUsersFile = pathlib.Path(
    r'././data/raw_data/steam_users_purchase_play.csv')
...
usedGames["genre_publisher_developer"] = usedGames['genre'] + \
    usedGames['publisher'] + usedGames['developer']
usedGames["genre_popular_tags_developer"] = usedGames['genre'] + \
    usedGames['popular_tags'] + usedGames['developer']
usedGames["genre_popular_tags_game_details"] = usedGames['genre'] + \
    usedGames['popular_tags'] + usedGames['game_details']
usedGames["genre_publisher_developer_game_details"] = usedGames['genre'] + \
    usedGames['publisher'] + usedGames['developer'] + usedGames['game_details']

usedGames.drop_duplicates("name")
usedGames.to_csv(pathlib.Path(
    r'././data/intermediate_data/processed_games_for_content-based.csv'), index=False)
