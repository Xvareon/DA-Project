...
# output csv
testUsers.to_csv(pathlib.Path(
    r'./data/model_data/steam_user_test.csv'), index=False)
trainUsers.to_csv(pathlib.Path(
    r'./data/model_data/steam_user_train.csv'), index=False)
